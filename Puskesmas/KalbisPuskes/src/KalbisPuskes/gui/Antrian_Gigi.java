 ...
 * @author IT
 */
public class Antrian_Gigi extends javax.swing.JFrame {
    Connection con = null;
    ResultSet rs = null;
    ...
    private void initComponents() {
        ...
        setTitle("Antrian Gigi");

        jLabel1.setFont(new java.awt.Font("Dialog", 1, 16)); // NOI18N
        jLabel1.setText("Gigi");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            String sql = "select * from antrian where bagian = 'Gigi' and flag_active='Y' ORDER BY tanggal DESC LIMIT 1";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Antrian_Gigi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Antrian_Gigi().setVisible(true);
            }
        });
    }
