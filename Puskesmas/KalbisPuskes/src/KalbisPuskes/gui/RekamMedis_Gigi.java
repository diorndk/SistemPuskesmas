 ...
 * @author DIOR
 */
public class RekamMedis_Gigi extends javax.swing.JFrame {
 public Tindakan_Gigi tg;
    Kasir ksr = new Kasir();
    Connection con = null;
    ResultSet rs = null;
    ResultSet rs1 = null;
    ...
    RekamMedis_Gigi.no_rekam = no_rekam;
    }
    ...
    public RekamMedis_Gigi() {
        ...
        generate_norekam();
        nomor_rekam_medis.setEditable(false);
    ...
    public void setupantri(){
        try
        {
            Calendar cal = new GregorianCalendar();
            int tanggal = cal.get(Calendar.DAY_OF_MONTH);
            String sql = "select no_antrian as 'Nomor Antri', no_registrasi as 'No. Registrasi', nama_pasien as 'Nama Pasien', tanggal_entri as Tanggal, nama_pengentri as Petugas from antrian where bagian ='gigi' and flag_active ='Y' or bagian ='gigi' and flag_skip ='Y' and tanggal='"+tanggal+"'";
            pst = con.prepareStatement(sql);
            rs = pst.executeQuery();
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(no_registrasi, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(nomor_rekam_medis, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(34, 34, 34)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(nomor_rekam_medis_lama, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(65, 65, 65))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabel11)
                        .addComponent(tgl_rekam_medis, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(9, 9, 9)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void tabel_antriMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabel_antriMouseClicked
        ...
        try{
            ...
            String sql = "select no_antrian as 'Nomor Antri', no_registrasi as 'No. Registrasi', nama_pasien as 'Nama Pasien', flag_active as 'Status Antrian', tanggal_entri as Tanggal, nama_pengentri as Petugas from antrian where bagian ='Gigi' and no_antrian = '"+klak+"' and no_registrasi='"+klik+"' ";
            pst = con.prepareStatement(sql);
            rs = pst.executeQuery();
            if(rs.next()){
    ...
    private void bSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSimpanActionPerformed
        // TODO add your handling code here:
        int p = JOptionPane.showConfirmDialog(null, "Anda yakin ingin menyimpan data?","Simpan Data",JOptionPane.YES_NO_OPTION);
        if(p==0){
            try{
                ...
                con.createStatement().execute("update rekam_medis set tgl_rekam_medis= DATE_FORMAT(NOW(),'%Y-%m-%d'), no_registrasi='"+value2+"', nama_pasien='"+value3+"', kode_resep='"+value5+"', keluhan='"+value7+"', tanggal_entri=DATE_FORMAT(NOW(),'%Y-%m-%d %T'), nama_dokter='"+value4+"' where nomor_rekam_medis='"+value1+"' ");
    ...
    private void btn_tindakanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tindakanActionPerformed
        // TODO add your handling code here:
        try{
            String insert ="insert into rekam_medis (nomor_rekam_medis, tgl_rekam_medis, no_registrasi, nama_pasien, kode_resep, keluhan, total_harga_tindakan, bagian, tanggal_entri, nama_dokter) values (?,DATE_FORMAT(NOW(),'%Y-%m-%d'),?,?,'00000000',?,'0','Gigi',DATE_FORMAT(NOW(),'%Y-%m-%d %T'),?)";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RekamMedis_Gigi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RekamMedis_Gigi().setVisible(true);
            }
        });
    }
